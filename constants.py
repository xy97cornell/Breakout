# constants.py
# Walker M. White (wmw2), Xiaoyu Yan (xy97), and Jeremy Glassman (jrg348)
# November 12, 2014
...
#: collide sounds
BREAK_SOUNDS = ["cup1.wav", "plate1.wav", "plate2.wav",
...
STATE_COMPLETE = 5
#: sounds
WIN_SOUND = 'wearethechampions.wav'
LOSE_SOUND = 'wahwah.wav'
